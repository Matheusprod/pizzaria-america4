...
// A seguir annotation do (Spring web MVC) dependências: "spring-boot=-starter-webmvc (pom.xml

// Annotation de classe

// @Controller: Sistema web (Sites em geral) - back-end + Front-end
//@RestController: Api (apenas em api's) - Apenas em back-end

//Annotation de métodos 

//@ GetMapping: Utilizado para "buscar" dados na API (Somente Pesquisa)
//@ PostMapping: Utilizado para "enviar" dados na API (Cadastros)
...
//ResponseEntity: Controla a resposta HTTP completa de um API, permitindo definir o corpo (body), o código de status (200, 201, 400 etc.)
